...
export const getInitializeAaveV2StrategyData = async (
  ...
  const {aave, aaveStakedToken, aaveLendingPool, aaveIncentivesController} =
...
export const getInitializeCompoundStrategyData = async (
  registry: string,
  bank: string,
  underlying: string,
  derivative: string
...
export const getInitializeCurve3PoolStrategyData = async (
  registry: string,
  bank: string,
  underlying: string,
  index: string
