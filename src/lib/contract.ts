...
export const getRegistryAt = async (address: string, signer: Signer | undefined) => {
  return (await ethers.getContractAt('OhRegistry', address, signer)) as OhRegistry;
};

export const getManagerAt = async (address: string, signer?: Signer) => {
  return (await ethers.getContractAt('OhManager', address, signer)) as OhManager;
};

export const getGovernorAt = async (address: string, signer?: Signer) => {
  return (await ethers.getContractAt('OhGovernor', address, signer)) as OhGovernor;
};

export const getForumAt = async (address: string, signer?: Signer) => {
  return (await ethers.getContractAt('OhForum', address, signer)) as OhForum;
};

export const getBankAt = async (address: string, signer: Signer | undefined) => {
  return (await ethers.getContractAt('OhBank', address, signer)) as OhBank;
};

export const getStrategyAt = async (address: string, signer: Signer | undefined) => {
  return (await ethers.getContractAt('OhStrategy', address, signer)) as OhStrategy;
};

export const getProxyAt = async (address: string, signer: Signer | undefined) => {
  return (await ethers.getContractAt('OhUpgradeableProxy', address, signer)) as OhUpgradeableProxy;
};

export const getAaveV2StrategyAt = async (address: string, signer?: Signer | undefined) => {
  return (await ethers.getContractAt('OhAaveV2Strategy', address, signer)) as OhAaveV2Strategy;
};

export const getCompoundStrategyAt = async (address: string, signer?: Signer | undefined) => {
  return (await ethers.getContractAt('OhCompoundStrategy', address, signer)) as OhCompoundStrategy;
};

export const getCurve3PoolStrategyAt = async (address: string, signer?: Signer | undefined) => {
