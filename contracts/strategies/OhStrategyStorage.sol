...
abstract contract OhStrategyStorage is Initializable, OhUpgradeable {
    bytes32 internal constant _BANK_SLOT =
        0xd2eff96e29993ca5431993c3a205e12e198965c0e1fdd87b4899b57f1e611c74;
    bytes32 internal constant _UNDERLYING_SLOT =
        0x0fad97fe3ec7d6c1e9191a09a0c4ccb7a831b6605392e57d2fedb8501a4dc812;
    bytes32 internal constant _DERIVATIVE_SLOT =
        0x4ff4c9b81c0bf267e01129f4817e03efc0163ee7133b87bd58118a96bbce43d3;
    bytes32 internal constant _REWARD_SLOT =
    ...
    function _bank() internal view returns (address) {
    ...
    function _derivative() internal view returns (address) {
        return getAddress(_DERIVATIVE_SLOT);
    }

    function _reward() internal view returns (address) {
